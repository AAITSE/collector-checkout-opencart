...
class ModelExtensionPaymentCollector extends Model {
	...
	public function install() {
        $this->db->query("
        CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "collector_payments` (
  ...
  KEY `order_id` (`order_id`)
        ...
        $this->db->query("
CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "collector_quote` (
  ...
  KEY `visitor_id` (`visitor_id`)
        ...
        $this->db->query("
CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "collector_visitors` (
